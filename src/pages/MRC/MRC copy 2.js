      ...
      <Box position="relative">
        <MuiThemeProvider theme={getMuiTheme()}>
          <div>
            ...
            {/* {isLoading && (
              <Box position="absolute" top="78%" left="40%" transform="translate(-50%, -50%)">
            ...
            />
            <Popup
              title="Style Wise Machine Requisition Form"
              openPopup={openPopup}
              setOpenPopup={setOpenPopup}
            >
              <MRCForm recordForEdit={recordForEdit} addOrEdit={addOrEdit} MachineList={MachineList}/>
            </Popup>
